...
export function SearchScreen() {
  ...
  const goToVendedor = (idVendedor) => {
    navigation.navigate(screen.vendedores.vendedor, {id: idVendedor});
  };
      ...
      <ScrollView>
        {size(searchResults) === 0 ? (
          ...
          map(searchResults, (item) => {
            ...
            return(
              <ListItem key={data.id} bottomDivider onPress={() => goToVendedor(data.id)} >
